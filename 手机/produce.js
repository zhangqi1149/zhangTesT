...
let Phoneconfig = {
    "16603089590": {
        ...
        "Data2":{
            ...
            "mutou.location.latitude":"38.849587",
            "mutou.location.longitude":"121.526121",
        },
    },
    "18588074571": {
        "Data1":{
    ...
    "18664265448": {
        ...
        "Data2":{
            ...
            "mutou.location.latitude":"38.888888",
            "mutou.location.longitude":"121.532535",
        }
    },
    "13242147820": {
        "Data1":{
        ...
        "Data2":{
            ...
            "mutou.location.latitude":"38.89925",
            "mutou.location.longitude":"121.521225",
        }
    },
    "13249423420": {
        "Data1":{
        ...
        "Data2":{
            ...
            "mutou.location.latitude":"38.861371",
            "mutou.location.longitude":"121.548062",
        }
    },
    "13077485596": {
        "Data1":{
        ...
        "Data2":{
            ...
            "mutou.location.latitude":"38.841234",
            "mutou.location.longitude":"121.512876",
        }
    },
    ...
    "15140482733": {
        "Data1":{
            "persist.android_id":"94f7b803973f9aa0",
            "persist.ro.build.type":"user",
            "persist.ro.build.tags":"release-keys",
            "persist.ro.build.version.release":"14",
            "persist.ro.build.version.release_or_codename":"14",
            ...
            "persist.ro.soc.model":"MSM8998",
            "persist.ro.product.board":"msm8998",
            "persist.ro.build.version.security_patch":"2016-02-16",
            "persist.ro.build.id":"APJ5.160216.633",
            "persist.ro.build.user":"BE",
            "persist.ro.build.host":"BE-5OKRJV",
            "persist.ro.build.date.utc":"1619549894",
            "persist.ro.build.version.incremental":"eng.BE.20210328.62979",
            "persist.ro.boot.serialno":"e7089409",
            "persist.ro.serialno":"e7089409",
            "persist.ro.build.display.id":"crdroid_OnePlus 6T-user 14 APJ5.160216.633 eng.BE.20210328.62979 release-keys",
            "persist.ro.build.description":"OnePlus 6T-user 8.0.0 RQ2A.210305.006 V9.2.3.0.OCAMIEK release-keys",
            "persist.ro.build.fingerprint":"oneplus/OnePlus 6T/OnePlus 6T/8.0.0/RQ2A.210305.006/V9.2.3.0.OCAMIEK:user/release-keys",
            "persist.wifi.mac":"b6:95:58:95:ac:f8",
        },
        "Data2":{
            "gsm.operator.numeric":"46007,00000",
            ...
            "gsm.operator.iso-country":"[cn, ]",
            "gsm.sim.operator.iso-country":"cn",
            "gsm.sim.operator.numeric":"46007,",
            "telephony_manager.imsi0":"460078865145444",
            "telephony_manager.phone.number0":"15140482733",
            "telephony_manager.nai0":"user487@chinamobileltd.com",
            "telephony_manager.datastate":"2",
            "telephony_manager.specificcarrierid0":"46007",
            "telephony_manager.carrierid0":"46007",
            "telephony_manager.specificcarrieridname0":"cn",
            "telephony_manager.carrieridname0":"cn",
            "SubscriptionInfo.mcc":"460",
            "SubscriptionInfo.mnc":"07",
            "gsm.version.baseband":"M6600A-W24.11.02P-65,M6600A-W24.11.02P-647",
            "telephony_manager.imei0":"867147034695452",
            "telephony_manager.imei1":"867147039475965",
            "telephony_manager.iccid0":"4600736054750691",
            "telephony_manager.iccid1":"4600715582296107",
            "mutou.location.latitude":"39.00147",
            "mutou.location.longitude":"121.630203",
        }
    },
    "18525473489": {
        "Data1":{
            "persist.android_id":"6a100505f7d77ec4",
            "persist.ro.build.type":"user",
            "persist.ro.build.tags":"release-keys",
            "persist.ro.build.version.release":"14",
            "persist.ro.build.version.release_or_codename":"14",
            ...
            "persist.ro.product.manufacturer":"xiaomi",
            "persist.ro.product.brand":"xiaomi",
            "persist.ro.product.model":"MI A2",
            "persist.ro.build.product":"miatoll",
            "persist.ro.soc.model":"SDM660",
            "persist.ro.product.board":"sdm660",
            "persist.ro.build.version.security_patch":"2017-04-08",
            "persist.ro.build.id":"API2.170408.026",
            "persist.ro.build.user":"tNQTx",
            "persist.ro.build.host":"tNQTx-0G85UC",
            "persist.ro.build.date.utc":"1636495057",
            "persist.ro.build.version.incremental":"eng.tNQTx.20211010.1433",
            "persist.ro.boot.serialno":"e4633113",
            "persist.ro.serialno":"e4633113",
            "persist.ro.build.display.id":"aospextended_miatoll-user 14 API2.170408.026 eng.tNQTx.20211010.1433 ",
            "persist.ro.build.description":"miatoll-user 13 RQ2A.210305.006 V11.0.5.0.QFNMIXM release-keys",
            "persist.ro.build.fingerprint":"xiaomi/miatoll/miatoll/13/RQ2A.210305.006/V11.0.5.0.QFNMIXM:user/",
            "persist.wifi.mac":"4e:11:39:2c:2a:7f",
        },
        "Data2":{
            "gsm.operator.numeric":"46006,00000",
            "gsm.operator.alpha":"China Unicom",
            ...
            "gsm.sim.operator.iso-country":"cn",
            "gsm.sim.operator.numeric":"46006,",
            "telephony_manager.imsi0":"460068128643645",
            "telephony_manager.phone.number0":"18525473489",
            "telephony_manager.nai0":"user5871@chinaunicom.com",
            "telephony_manager.datastate":"2",
            "telephony_manager.specificcarrierid0":"46006",
            "telephony_manager.carrierid0":"46006",
            "telephony_manager.specificcarrieridname0":"cn",
            ...
            "SubscriptionInfo.mcc":"460",
            "SubscriptionInfo.mnc":"06",
            "gsm.version.baseband":"M6600A-W24.11.02P-449,M6600A-W24.11.02P-413",
            "telephony_manager.imei0":"867147036570563",
            "telephony_manager.imei1":"867147033851070",
            "telephony_manager.iccid0":"4600691325536948",
            "telephony_manager.iccid1":"4600632009843190",
            "mutou.location.latitude":"38.958354",
            "mutou.location.longitude":"121.52766",
        }
    }, 
}
